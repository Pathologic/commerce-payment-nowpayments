 ...
 * @internal    @properties &title=Title;text; &api_key=API Key;text; &secret_key=Secret Key;text; &debug=Debug;list;No==0||Yes==1;0 &test=Test mode;list;No==0||Yes==1;0 &partial_payment_status=Partial payment status ID;text;
